            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              {oauthProvider && (
                <Alert>
                  ...
                  <AlertDescription>
                    Your {oauthProvider} account is not registered yet. Please complete signup.
                  </AlertDescription>
                </Alert>
              )}
                ...
                <div>
                  ...
                  <div className="relative mt-2">
                    ...
                    <button
                      ...
                      className="absolute right-3 top-3 text-xs text-violet-500 hover:text-violet-700"
                    >
                ...
                <div>
                  ...
                  <div className="relative mt-2">
                    ...
                    <button
                      ...
                      className="absolute right-3 top-3 text-xs text-fuchsia-500 hover:text-fuchsia-700"
                    >
